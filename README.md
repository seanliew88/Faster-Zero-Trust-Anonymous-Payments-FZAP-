...
Flare's Data Collector is used to ensure that the Merchant has received the transaction and to prove to the Buyer that the transaction has been successful.
