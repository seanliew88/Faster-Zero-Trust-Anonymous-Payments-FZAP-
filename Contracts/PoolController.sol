...
contract QuantumSwapPoolController {
    ...
    mapping(uint256 => QuantumPoolTypes.Deposit) private deposits;
    uint256 public depositCount; 

    mapping(uint256 => QuantumPoolTypes.Claim) private claims;
    ...
    function deposit(uint256 amount, bytes32 commitmentHash) external poolOpen {
        ...
        deposits[depositCount] = QuantumPoolTypes.Deposit({
            buyer: msg.sender,
            amount: amount,
    ...
    function registerClaim(
        ...
        claims[claimCount] = QuantumPoolTypes.Claim({
            seller: seller,
    ...
    function recordSettlement(
        ...
        QuantumPoolTypes.Claim storage c = claims[claimId];
    ...
    function getDeposit(uint256 id) external view returns (QuantumPoolTypes.Deposit memory) {
        return deposits[id];
    }

    function getClaim(uint256 id) external view returns (QuantumPoolTypes.Claim memory) {
        return claims[id];
    }
